...
#获得深度图单位与米单位之间的映射关系,深度图单位*比例系数depth_scale才能得到真实深度
print("Depth Scale is: " , depth_scale)
#设置高精度模式(未找到对应设置)
# if depth_sensor and depth_sensor.is_depth_sensor():
# 		depth_sensor.set_option(rs.option.visual_preset,rs.rs400_visual_preset_high_density)
# 		print("高密度模式已开启")
...
try:
    while True:
        ...
        # imagetest = cv2.cvtColor(color_image, cv2.COLOR_BGR2RGB)
        filename = 'pose.jpg'
        IMG_SIZE = 224
